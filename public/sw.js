...
const CACHE_VERSION = "gbh-v2026-08-04e";  // Espejo v2: la 2ª frase ROTA por día del mes entre mejor/floja/tendencia (constancia siempre 1ª) y la tendencia se ancla a la semana de HOY frente a su adyacente (un lunes sin base ya no llama "esta semana" a la pasada).
