...
const CACHE_VERSION = "gbh-v2026-08-10f";  // FIX duelo: jfx perdido congelaba el rAF al primer golpe; la X ahora registra la partida en curso (0 pts) y cierra el exploit.
