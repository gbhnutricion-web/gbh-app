...
const CACHE_VERSION = "gbh-v2026-08-04d";  // El espejo: frases con números propios al completar el día (tras la celebración, cede paso al paywall de victoria) + tarjeta del lunes con la semana anterior + agregación unificada con SeguimientoView (espejoAgregar) + tests/espejo.test.mjs.
