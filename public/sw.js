...
const CACHE_VERSION = "gbh-v2026-08-04c";  // Transición trial→free correcta: plan EFECTIVO en el panel (trial/plan_until vencidos se muestran como 🆓) y curación de la BD al abrir el panel con PATCH condicionado en servidor. + GBH_Trial_a_Free.sql (curación puntual y cron opcional).
