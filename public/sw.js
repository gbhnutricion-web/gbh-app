...
const CACHE_VERSION = "gbh-v2026-08-07m";  // ARREGLO: el popup 🛒 Comprar del recetario abría una pantalla vacía. La capa de movimiento dejaba un transform residual en el contenedor de la pestaña y en los elementos escalonados, y eso los convierte en bloque contenedor: los position:fixed se posicionaban respecto a la pestaña (miles de px de alto) en vez de respecto a la ventana. El contenedor suelta la animación al acabar y el escalonado termina en transform:none.
