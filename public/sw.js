...
const CACHE_VERSION = "gbh-v2026-08-04h";  // FASE 1 del brief de paleta — SIN CAMBIO VISUAL. Normalización completa de colores: 361 literales de tema → tokens T.* + helper alpha(); tokens semánticos nuevos (compra, platos, moneda, llama1-4, llamaGlow); arte excluido y señalizado (PAL, consts del Mascot). Equivalencia verificada por render inverso de las 312 líneas cambiadas. Prepara la fase 2 (marca GBH) como edición de un solo objeto.
