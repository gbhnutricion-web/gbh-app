...
const CACHE_VERSION = "gbh-v2026-08-07i";  // Tutorial de alta: el bloque del plan pasa a ser un solo movimiento (receta → registro del plato → lista de la compra), sin salir y volver a Platos diarios. Ranking con la oveja personalizada en las tres tablas. Bo vivo en Inicio sin culpa y push de OneSignal eliminadas.
