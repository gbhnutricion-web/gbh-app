...
const CACHE_VERSION = "gbh-v2026-08-06";  // El tutorial interactivo: alta conversacional con Bo (formulario antiguo fuera, login intacto), cascada del alta que ya NUNCA sacrifica la prueba (+ traza en referral_events y red de reparación al entrar), tour guiado por spotlight con acciones reales (agua, objetivo, meta de racha, programación, receta, lista de la compra, primera comida), regeneración y cambios de receta gratis durante el trial, y cierre-celebración. BienvenidaBo desaparece del arranque.
