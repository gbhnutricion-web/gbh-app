...
const CACHE_VERSION = "gbh-v2026-07-21d";  // Capacitor: deteccion de app nativa, checkout/tarifas ocultos en iOS nativo (App Store 3.1.1) y push nativo OneSignal via plugin.
