...
const CACHE_VERSION = "gbh-v2026-08-07g";  // Bo vivo en Inicio: el estado deja de ser fijo y refleja el día del paciente (feliz · hambrienta · dormida · normal), con la regla ética «Bo nunca culpabiliza» — "triste" NO existe en Inicio, la ausencia se pinta como descanso. Bocadillo de las 20:00 reescrito en clave de invitación. Limpieza total de las push de OneSignal: init web y nativo, botón de la tarjeta de perfil, banner del 2º día e importScripts de este worker.
