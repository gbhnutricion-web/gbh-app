...
const CACHE_VERSION = "gbh-v2026-07-13c";  // Fix persistencia Bo: guardarBo escribe la caché local y loadP conserva los campos bo_* (color/skins/nombre/carácter) al reentrar
