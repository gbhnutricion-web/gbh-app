...
const CACHE_VERSION = "gbh-v2026-08-12a";  // FIX racha: la celebración se disparaba DESPUÉS de saveLog+addXG; un fallo de red la abortaba en silencio. Ahora va dentro del gesto. + sbReq await r.json() + saveLog no pisa la última toma.
