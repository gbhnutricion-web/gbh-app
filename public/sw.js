...
const CACHE_VERSION = "gbh-v2026-07-18b";  // WhatsApp con mensaje formateado (emojis escapados, fecha, negritas) + enlace publico al informe (/?informe=ID) con visor sin login.
