...
const CACHE_VERSION = "gbh-v2026-08-04f";  // Juice fase 1, tareas A+B: helper haptic() gemelo de SFX (mismo mute, feature-check iOS, solo en gestos del usuario; toma 10ms · misión doble · racha [0,30,60,30,60,90] · error) + micro-feedback al marcar tomas (bounceIn + partícula floatUp en MealBtns, popIn en los chips del plan diario, degradado con prefers-reduced-motion). Bundle +1,2 KB min (+0,45 KB gzip).
