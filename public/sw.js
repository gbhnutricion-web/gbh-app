...
const CACHE_VERSION = "gbh-v2026-07-13f";  // Fix: la semana vigente vuelve a ser la MÁS RECIENTE por fecha de publicación (fecha_gen), no la que marque semana_actual. Coherente con la generación (planes[0]).
