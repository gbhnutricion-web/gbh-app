...
const CACHE_VERSION = "gbh-v2026-08-04g";  // FIX CRÍTICO móvil: hooks condicionales en MRow (useContext dentro del template de misión completada), StreakOverlay y LevelUpOverlay (useLang tras el return null) reventaban el render JUSTO al celebrar y el ErrorBoundary se tragaba el overlay — por eso las animaciones salían en el visualizador (remonta constantemente) y no en la PWA. + La celebración de racha ahora la protagoniza LA OVEJA PERSONALIZADA del paciente (color, accesorios y nombre de Inicio) vía MascotaCelebracion, punto único de sustitución (Tarea F adelantada). Bundle −1,3 KB.
