...
// Avatar replaced by SVG expressions
...
// ─── Sheep SVG expressions ────────────────────────────────────────────────────
// Each expression is a self-contained SVG sheep face (200×200 viewBox)
// Shared anatomy: wool body, horns, ears, face oval.  Only eyes/brows/mouth differ.

function SheepFace({expr="idle", size=200}){
  // ── Shared parts ──────────────────────────────────────────────
  // Wool body: layered circles to create fluffy 3D look
  const Wool=()=>(
    <g>
      {/* Back shadow */}
      <ellipse cx="100" cy="115" rx="78" ry="65" fill="#1B4A20"/>
      {/* Main body */}
      <circle cx="100" cy="112" r="72" fill="#2D6B30"/>
      {/* Fluffy bumps around the edge */}
      {[[-48,28],[48,28],[-62,0],[62,0],[-55,-25],[55,-25],[-38,-50],[38,-50],[0,-58],[-18,-55],[18,-55]].map(([dx,dy],i)=>(
        <circle key={i} cx={100+dx} cy={100+dy} r={22} fill="#346E37" opacity="0.9"/>
      ))}
      {/* Inner highlight */}
      <ellipse cx="100" cy="100" rx="55" ry="50" fill="#3A7A3D"/>
      {/* Top highlight gloss */}
      <ellipse cx="85" cy="70" rx="22" ry="14" fill="#4A9150" opacity="0.55" transform="rotate(-15,85,70)"/>
    </g>
  );
  ...
  const Horns=()=>(
    <g>
      {/* Left horn */}
      <path d="M 58 58 C 38 40 22 28 30 12 C 36 2 52 8 56 22 C 60 35 56 48 58 58Z"
        fill="#7A5230" stroke="#5A3A18" strokeWidth="1.5"/>
      <path d="M 52 50 C 36 36 24 26 30 14 C 33 6 44 10 48 20 C 52 30 50 42 52 50Z"
        fill="#8B6040" opacity="0.7"/>
      {/* Right horn */}
      <path d="M 142 58 C 162 40 178 28 170 12 C 164 2 148 8 144 22 C 140 35 144 48 142 58Z"
        fill="#7A5230" stroke="#5A3A18" strokeWidth="1.5"/>
      <path d="M 148 50 C 164 36 176 26 170 14 C 167 6 156 10 152 20 C 148 30 150 42 148 50Z"
        fill="#8B6040" opacity="0.7"/>
    </g>
  );
  ...
  const Ears=()=>(
    <g>
      {/* Left ear */}
      <ellipse cx="34" cy="108" rx="16" ry="22" fill="#2D6B30" transform="rotate(-20,34,108)"/>
      <ellipse cx="34" cy="108" rx="9" ry="14" fill="#C06060" opacity="0.7" transform="rotate(-20,34,108)"/>
      {/* Right ear */}
      <ellipse cx="166" cy="108" rx="16" ry="22" fill="#2D6B30" transform="rotate(20,166,108)"/>
      <ellipse cx="166" cy="108" rx="9" ry="14" fill="#C06060" opacity="0.7" transform="rotate(20,166,108)"/>
    </g>
  );
  ...
  const FaceOval=()=>(
    <g>
      {/* Face oval */}
      <ellipse cx="100" cy="118" rx="46" ry="44" fill="#2A6030"/>
      <ellipse cx="100" cy="116" rx="40" ry="38" fill="#306835"/>
      {/* Nose */}
      <ellipse cx="100" cy="142" rx="14" ry="8" fill="#1E4A22"/>
      <ellipse cx="96" cy="140" rx="4.5" ry="3.5" fill="#0D2210"/>
      <ellipse cx="104" cy="140" rx="4.5" ry="3.5" fill="#0D2210"/>
    </g>
  );
  ...
  const Eyes={
    idle:(
      <g>
        {/* Left eye */}
        <circle cx="82" cy="112" r="13" fill="white"/>
        <circle cx="82" cy="112" r="9" fill="#4A7A20"/>
        <circle cx="82" cy="112" r="6" fill="#1A2A0A"/>
        <circle cx="79" cy="109" r="2.5" fill="white" opacity="0.9"/>
        <circle cx="85" cy="114" r="1.2" fill="white" opacity="0.5"/>
        {/* Right eye */}
        <circle cx="118" cy="112" r="13" fill="white"/>
        <circle cx="118" cy="112" r="9" fill="#4A7A20"/>
        <circle cx="118" cy="112" r="6" fill="#1A2A0A"/>
        <circle cx="115" cy="109" r="2.5" fill="white" opacity="0.9"/>
        <circle cx="121" cy="114" r="1.2" fill="white" opacity="0.5"/>
        {/* Eyebrows — neutral */}
        <path d="M72 96 Q82 92 92 95" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>
        <path d="M108 95 Q118 92 128 96" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>
      </g>
    ),
    happy:(
      <g>
        {/* Left eye — squinting happy */}
        <ellipse cx="82" cy="112" rx="13" ry="10" fill="white"/>
        <ellipse cx="82" cy="113" rx="9" ry="7" fill="#4A7A20"/>
        <ellipse cx="82" cy="113" rx="6" ry="5" fill="#1A2A0A"/>
        <circle cx="79" cy="110" r="2.2" fill="white" opacity="0.9"/>
        {/* Right eye */}
        <ellipse cx="118" cy="112" rx="13" ry="10" fill="white"/>
        <ellipse cx="118" cy="113" rx="9" ry="7" fill="#4A7A20"/>
        <ellipse cx="118" cy="113" rx="6" ry="5" fill="#1A2A0A"/>
        <circle cx="115" cy="110" r="2.2" fill="white" opacity="0.9"/>
        {/* Eyebrows — raised happy */}
        <path d="M72 93 Q82 88 92 92" stroke="#1E4A22" strokeWidth="3.2" fill="none" strokeLinecap="round"/>
        <path d="M108 92 Q118 88 128 93" stroke="#1E4A22" strokeWidth="3.2" fill="none" strokeLinecap="round"/>
        {/* Cheek blush */}
        <ellipse cx="68" cy="122" rx="10" ry="6" fill="#E8706A" opacity="0.35"/>
        <ellipse cx="132" cy="122" rx="10" ry="6" fill="#E8706A" opacity="0.35"/>
      </g>
    ),
    excited:(
      <g>
        {/* Left eye — WIDE */}
        <circle cx="82" cy="111" r="15" fill="white"/>
        <circle cx="82" cy="111" r="10" fill="#5A9020"/>
        <circle cx="82" cy="111" r="7" fill="#0D1A05"/>
        <circle cx="78" cy="107" r="3" fill="white" opacity="0.95"/>
        <circle cx="86" cy="115" r="1.5" fill="white" opacity="0.5"/>
        {/* Right eye — WIDE */}
        <circle cx="118" cy="111" r="15" fill="white"/>
        <circle cx="118" cy="111" r="10" fill="#5A9020"/>
        <circle cx="118" cy="111" r="7" fill="#0D1A05"/>
        <circle cx="114" cy="107" r="3" fill="white" opacity="0.95"/>
        <circle cx="122" cy="115" r="1.5" fill="white" opacity="0.5"/>
        {/* Eyebrows — raised high excited */}
        <path d="M70 90 Q82 84 93 89" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        <path d="M107 89 Q118 84 130 90" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        {/* Sparkle glints */}
        <circle cx="94" cy="100" r="2" fill="white" opacity="0.8"/>
        <circle cx="106" cy="98" r="1.5" fill="white" opacity="0.6"/>
      </g>
    ),
    celebrating:(
      <g>
        {/* Left eye — closed happy arc */}
        <path d="M70 112 Q82 103 94 112" stroke="#1E4A22" strokeWidth="4" fill="none" strokeLinecap="round"/>
        {/* Right eye — closed happy arc */}
        <path d="M106 112 Q118 103 130 112" stroke="#1E4A22" strokeWidth="4" fill="none" strokeLinecap="round"/>
        {/* Eyebrows — super raised */}
        <path d="M70 96 Q82 90 93 95" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        <path d="M107 95 Q118 90 130 96" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        {/* Cheek stars */}
        <text x="62" y="126" fontSize="13" textAnchor="middle" fill="#FFD700">★</text>
        <text x="138" y="126" fontSize="13" textAnchor="middle" fill="#FFD700">★</text>
        {/* Blush */}
        <ellipse cx="68" cy="122" rx="11" ry="7" fill="#E8706A" opacity="0.5"/>
        <ellipse cx="132" cy="122" rx="11" ry="7" fill="#E8706A" opacity="0.5"/>
      </g>
    ),
    sad:(
      <g>
        {/* Left eye — droopy */}
        <circle cx="82" cy="114" r="12" fill="white"/>
        <circle cx="82" cy="115" r="8" fill="#3A6018"/>
        <circle cx="82" cy="115" r="5.5" fill="#1A2A0A"/>
        <circle cx="79" cy="112" r="2" fill="white" opacity="0.8"/>
        {/* Right eye — droopy */}
        <circle cx="118" cy="114" r="12" fill="white"/>
        <circle cx="118" cy="115" r="8" fill="#3A6018"/>
        <circle cx="118" cy="115" r="5.5" fill="#1A2A0A"/>
        <circle cx="115" cy="112" r="2" fill="white" opacity="0.8"/>
        {/* Tear drops */}
        <ellipse cx="82" cy="128" rx="2.5" ry="4" fill="#88CCFF" opacity="0.8"/>
        <ellipse cx="118" cy="128" rx="2.5" ry="4" fill="#88CCFF" opacity="0.8"/>
        {/* Eyebrows — sad slant inward */}
        <path d="M72 94 Q82 98 91 94" stroke="#1E4A22" strokeWidth="3.2" fill="none" strokeLinecap="round"/>
        <path d="M109 94 Q118 98 128 94" stroke="#1E4A22" strokeWidth="3.2" fill="none" strokeLinecap="round"/>
      </g>
    ),
    sleeping:(
      <g>
        {/* Left eye — closed flat line */}
        <path d="M70 112 Q82 115 94 112" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        {/* Right eye — closed flat line */}
        <path d="M106 112 Q118 115 130 112" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        {/* Eyelashes */}
        <path d="M72 112 L70 108" stroke="#1E4A22" strokeWidth="2" strokeLinecap="round"/>
        <path d="M82 114 L82 110" stroke="#1E4A22" strokeWidth="2" strokeLinecap="round"/>
        <path d="M92 112 L94 108" stroke="#1E4A22" strokeWidth="2" strokeLinecap="round"/>
        <path d="M108 112 L106 108" stroke="#1E4A22" strokeWidth="2" strokeLinecap="round"/>
        <path d="M118 114 L118 110" stroke="#1E4A22" strokeWidth="2" strokeLinecap="round"/>
        <path d="M128 112 L130 108" stroke="#1E4A22" strokeWidth="2" strokeLinecap="round"/>
        {/* Relaxed eyebrows */}
        <path d="M73 97 Q82 95 91 97" stroke="#1E4A22" strokeWidth="2.8" fill="none" strokeLinecap="round"/>
        <path d="M109 97 Q118 95 127 97" stroke="#1E4A22" strokeWidth="2.8" fill="none" strokeLinecap="round"/>
      </g>
    ),
    legend:(
      <g>
        {/* Left eye — confident half-squint */}
        <ellipse cx="82" cy="113" rx="13" ry="9" fill="white"/>
        <ellipse cx="83" cy="113" rx="9" ry="7" fill="#5A9020"/>
        <ellipse cx="83" cy="113" rx="6" ry="5" fill="#0D1A05"/>
        <circle cx="80" cy="110" r="2.5" fill="white" opacity="0.9"/>
        {/* Upper lid — squinting top */}
        <path d="M69 108 Q82 104 95 108" stroke="#2A5A10" strokeWidth="4" fill="none" strokeLinecap="round"/>
        {/* Right eye — wide open confident */}
        <circle cx="118" cy="112" r="13" fill="white"/>
        <circle cx="118" cy="112" r="9" fill="#5A9020"/>
        <circle cx="118" cy="112" r="6" fill="#0D1A05"/>
        <circle cx="115" cy="109" r="2.5" fill="white" opacity="0.9"/>
        {/* Eyebrows — one raised, one normal */}
        <path d="M72 94 Q82 90 92 95" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        <path d="M108 97 Q118 93 128 97" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>
        {/* Gold glints */}
        <circle cx="94" cy="101" r="2.5" fill="#FFD700" opacity="0.9"/>
        <circle cx="89" cy="95" r="1.5" fill="#FFD700" opacity="0.7"/>
        <circle cx="132" cy="98" r="2" fill="#FFD700" opacity="0.8"/>
      </g>
    ),
  };

  // ── Mouths per expression ─────────────────────────────────────
  const Mouths={
    idle:    <path d="M88 152 Q100 157 112 152" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>,
    happy:   <path d="M84 150 Q100 163 116 150" stroke="#1E4A22" strokeWidth="3.5" fill="none" strokeLinecap="round"/>,
    excited: (
      <g>
        <path d="M82 150 Q100 168 118 150" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>
        <ellipse cx="100" cy="158" rx="12" ry="8" fill="#1A2A0A" opacity="0.6"/>
      </g>
    ),
    celebrating:(
      <g>
        <path d="M80 150 Q100 170 120 150" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>
        <ellipse cx="100" cy="160" rx="14" ry="9" fill="#1A2A0A" opacity="0.7"/>
        <path d="M88 154 Q100 160 112 154" fill="#CC4444" opacity="0.5"/>
      </g>
    ),
    sad:     <path d="M86 156 Q100 148 114 156" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>,
    sleeping:<path d="M88 154 Q100 158 112 154" stroke="#1E4A22" strokeWidth="2.5" fill="none" strokeLinecap="round"/>,
    legend:  (
      <g>
        <path d="M86 150 Q100 161 118 154" stroke="#1E4A22" strokeWidth="3" fill="none" strokeLinecap="round"/>
        <circle cx="118" cy="154" r="3" fill="#FFD700" opacity="0.8"/>
      </g>
    ),
  };
  ...
  const glowColor=expr==="legend"?"rgba(255,200,0,0.4)":"rgba(88,204,2,0.32)";
  const animMap={
    idle:"float 3.5s ease-in-out infinite",
    happy:"float 3.5s ease-in-out infinite",
    excited:"bounce 0.7s ease-in-out infinite",
    celebrating:"bounce 0.65s ease-in-out infinite",
    sad:"none",
    sleeping:"none",
    legend:"bounce 1.1s ease-in-out infinite",
  };

  return(
    <div style={{position:"relative",width:size,height:size,flexShrink:0}}>
      {/* Glow aura ring */}
      {glow&&<div style={{position:"absolute",inset:-size*0.14,borderRadius:"50%",background:`radial-gradient(circle,${glowColor} 0%,transparent 65%)`,animation:"aura 2.5s ease-in-out infinite",pointerEvents:"none"}}/>}

      {/* SVG face */}
      <div style={{width:"100%",height:"100%",animation:animMap[expr]}}>
        <svg viewBox="0 0 200 200" style={{width:"100%",height:"100%",overflow:"visible",filter:expr==="sleeping"?"brightness(0.85)":expr==="sad"?"brightness(0.88) saturate(0.8)":"none"}}>
          <Wool/>
          <Ears/>
          <Horns/>
          <FaceOval/>
          {Eyes[expr]||Eyes.idle}
          {Mouths[expr]||Mouths.idle}
        </svg>
      </div>
      ...
      {expr==="sleeping"&&(
        <>
          <div style={{position:"absolute",top:"5%",right:"0%",fontSize:size*0.14,color:"#FFC800",fontWeight:900,animation:"zFloat 1.5s ease-in-out infinite",fontFamily:"'Nunito',sans-serif",textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>z</div>
          <div style={{position:"absolute",top:"-5%",right:"-8%",fontSize:size*0.18,color:"#FFC800",fontWeight:900,animation:"zFloat 1.5s 0.4s ease-in-out infinite",fontFamily:"'Nunito',sans-serif",textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>Z</div>
          <div style={{position:"absolute",top:"-16%",right:"-3%",fontSize:size*0.22,color:"#FFC800",fontWeight:900,animation:"zFloat 1.5s 0.8s ease-in-out infinite",fontFamily:"'Nunito',sans-serif",textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>Z</div>
        </>
      )}

      {/* Legend crown */}
      {expr==="legend"&&<div style={{position:"absolute",top:"-18%",left:"50%",transform:"translateX(-50%)",fontSize:size*0.3,filter:"drop-shadow(0 2px 8px rgba(255,200,0,0.8))",animation:"wobble 1.2s ease-in-out infinite",lineHeight:1}}>👑</div>}

      {/* Celebrating confetti */}
      {expr==="celebrating"&&<div style={{position:"absolute",top:"-5%",right:"-10%",fontSize:size*0.28,animation:"wobble 0.6s ease-in-out infinite",lineHeight:1}}>🎉</div>}

      {/* Excited fire */}
      {expr==="excited"&&<div style={{position:"absolute",top:"-8%",right:"-8%",fontSize:size*0.24,animation:"bounce 0.5s ease-in-out infinite",lineHeight:1}}>🔥</div>}
    </div>
  );
}

// Mascot = SheepFace (alias para compatibilidad con el resto del código)
const Mascot = SheepFace;
