...
export const FICHAS = [
  ...
  { v: "Vegetariana", prop: "huevo", acento: "#FFD84D",
    ...
    estilo: { es: "Sin carne, con pescado", en: "No meat, with fish" },
    para:   { es: "Ovolacto y pescetarianos", en: "Ovo-lacto & pescatarians" },
    desc:   { es: "Huevo, lácteos, pescado, legumbres, cereales y vegetales. La misma variedad de tomas, sin carne.",
              en: "Eggs, dairy, fish, legumes, grains and vegetables. Same variety of meals, without meat." } },
